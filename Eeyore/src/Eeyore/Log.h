...
#include "spdlog/fmt/ostr.h"//ostream
...
#define ER_CORE_FATAL(...)		::Eeyore::Log::GetCoreLogger()->critical(__VA_ARGS__)
...
#define ER_FATAL(...)			::Eeyore::Log::GetClientLogger()->critical(__VA_ARGS__)
